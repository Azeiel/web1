	...
	<form action = "?oldal=belep" method = "post">
      <fieldset>
        <legend><h1><strong>Belépés</strong></h1></legend>
        <br>
        <input type="text" name="felhasznalo" placeholder="felhasználó" required><br><br>
        <input type="password" name="jelszo" placeholder="jelszó" required><br><br>
        <input type="submit" name="belepes" value="Belépés" class="button2">
        <br>&nbsp;
      </fieldset>
    </form>
	 <p class="inset">   </p>
    ...
    <form action = "?oldal=regisztral" method = "post">
      <fieldset>
        <legend><h1><strong>Regisztráció</strong></h1></legend>
        <br>
        ...
        <input type="text" name="felhasznalo" placeholder="felhasználó" required><br><br>
        <input type="password" name="jelszo" placeholder="jelszó" required><br><br>
        <input type="submit" name="regisztracio" value="Regisztráció" class="button2">
        <br>&nbsp;
      </fieldset>
    </form>
	<p class="inset">   </p> 

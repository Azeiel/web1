...
<div class="desc">			
	...
	<br><br>
	   <h1><strong>Feltöltés a képgalériába:</strong></h1>
	   <br>
...
?>
<?php if($ne==true){ ?>
<h5>Be vagy jelentkezve ,feltölthetsz képeket.</h5><br>
<?php
}
else
{
?>
<h5>Nem vagy bejenkezve ,nem tölthetsz fel képeket.</h5><br>
<?php }	?>

    <form method="post"
                enctype="multipart/form-data">
				
        <label><strong>Feltöltés:</strong> </label> <input type="file" name="elso" required><br>
       <br>
